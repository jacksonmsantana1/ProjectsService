...
// removePins :: Database:db -> String:projectId -> String:userId -> Promise(Error, Boolean)
const removePins = require('../../../../../Project/index').removePins;

// despin :: Database:db -> Request -> Promise(Error, Boolean)
const despin = curry((db, request) =>
  removePins(db, getRequestParams(request), getCredential(request))
...
const sendResponse = curry((request, reply, ok) => {
  request.log('/projects/{id}/despinned',
